...
//CODE HERE
  //to delete a property, we can simply use the delete method
...
//CODE HERE
for(var a = 0; a <lettersToPair.length; i++){
 for(var b = 0; b < lettersToPair.length; i++){
    if(a!=b){
        if(lettersToPair[a] == lettersToPair[b]){
            let new_arr = [a, b];
            pairsArray.push(new_arr)
        }
    }
 }
}
...
//CODE HERE
  var teachStay = teachTrick.bind(fido, 'stay')
...
//CODE HERE
var fidoIntro =  dogIntro.apply(fido, 'chicken', 'tennis ball')
...
//CODE HERE
  let phone1 = new Phone("test", "Test1", 3, "blue", false)
  
  let phone2 =  new Phone("test", "Test1", 3, "blue", false)
  
  let phone3 =  new Phone("test", "Test1", 3, "blue", false)
...
//CODE HERE
phone1.prototype.sell = function(){
    this.sold = true;
